...
```
┌─────────────────────┐    ┌─────────────────────┐    ┌─────────────────────┐
│   Cloudflare Pages  │───▶│   Kubernetes API    │───▶│     MongoDB         │
│   (Frontend)        │    │   (Backend)         │    │   (Database)        │
│   • index.html      │    │   • Rate Limiting   │    │   • Readings Cache  │
│   • discover-zodiac │    │   • Circuit Breaker │    │   • Metadata        │
│   • Mobile Menu     │    │   • Retry Logic     │    │                     │
└─────────────────────┘    └─────────────────────┘    └─────────────────────┘
                                      │
                                      ▼
                           ┌─────────────────────┐
...
- **🤖 Blackbox AI Integration**: Switched from Google Gemini to Blackbox AI with 12+ free model fallback
- **🔄 Circuit Breaker Pattern**: Intelligent failure handling with automatic recovery
- **📱 Mobile Navigation**: Burger menu with smooth animations for mobile users
- **🔍 Discover Page**: Dedicated zodiac traits page with clickable navigation
- **📝 Markdown Support**: Rich content formatting for API responses
- **⚡ Rate Limiting Fixes**: Kubernetes probe whitelisting prevents 429 errors
- **🎯 Enhanced UX**: Automatic sign selection from discover page to readings
- **🛡️ Error Handling**: Comprehensive retry logic ensures 100% reading generation success
